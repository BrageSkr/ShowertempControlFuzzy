...
flow_setpoints = [0.5, 0.5, 0.5, 0.5, 1, 1, 1, 1, 1]
# Periodic changes in flow setpoint

# Lists to store simulation data
# Lists to store simulation data
time_steps = []
temp_actual = [15]  # Initial condition for temperature
flow_actual = [0.5]  # Initial condition for flow
